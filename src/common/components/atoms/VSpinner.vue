...
const { size, inputClass } = toRefs(props);
...
<template>
  <div role="status">
    <svg aria-hidden="true" class="animate-spin fill-primary text-gray-200" :class="localInputClass" viewBox="0 0 100 101"
