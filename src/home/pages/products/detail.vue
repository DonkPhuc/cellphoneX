...
<template>
  <main class="mx-auto py-4 lg:w-[65%]">
    <div class="flex flex-col gap-4">
      <div class="flex w-full items-center gap-4 border-b-2 py-2">
        <span class="text-lg font-bold text-black">{{ currentProduct[0].name }}</span>
        <div class="flex text-sm font-thin text-gray-400">
          <span>{{ currentProduct[0].title }}</span>
          <div class="flex pl-8">
      ...
      <div class="flex gap-4 border-b-2 py-4">
        <div class="flex-1">
          ...
          <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-4 rounded-xl border p-4">
              ...
              <span class="flex items-center gap-2">
                ...
                />
                <p class="text-sm font-extralight">
                  Bảo hành 24 tháng tại trung tâm bảo hành Chính hãng. 1 đổi 1 trong 30 ngày nếu có lỗi phần cứng từ nhà
                  sản xuất.
                </p>
              </span>
            </div>
